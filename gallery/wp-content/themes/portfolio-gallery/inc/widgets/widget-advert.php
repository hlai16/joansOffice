...
class Portfolio_gallery_adv extends WP_Widget
{
    function __construct(){
		$widget_ops = array('description' => __('Displays Advertisements', "portfolio-gallery"));
		$control_ops = array('width' => 400, 'height' => 500);
		parent::__construct(false,$name=__('Advertisement', "portfolio-gallery"), $widget_ops,$control_ops);
	}
...
echo $after_widget;
  ...
  /*Creates the form for the widget in the back-end. */
    function form($instance){
			...
			$instance = wp_parse_args( (array) $instance, array('title'=>__('Advertisement', "portfolio-gallery"), 'bannerPath'=>'', 'bannerUrl'=>'', 'bannerTitle'=>'', 'bannerAlt'=>'') );
		...
		.Remove_Banner{
			...
			<?php }}else {?>
				...
				<?php  } ?>
				<input type="button" onclick="add_banner(this)" value="<?php esc_attr_e('Add Banner', "portfolio-gallery"); ?>" />
