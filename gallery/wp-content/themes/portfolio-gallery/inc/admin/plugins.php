...
function wdwt_register_required_plugins() {
	...
	$config = array(
		...
		'strings'      => array(
			...
			/* translators: %s: plugin name. * /
			'updating'                        => __( 'Updating Plugin: %s', "portfolio-gallery" ),
			...
			'notice_cannot_install_activate'  => __( 'There are one or more required or recommended plugins to install, update or activate.', "portfolio-gallery" ),
